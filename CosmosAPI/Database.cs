...
namespace CosmosAPI
{
    public class CosmosDB
    {
        ...
        private static readonly string EndpointUri = "https://igormoreira.documents.azure.com:443/";

        // The primary key for the Azure Cosmos account.
        private static readonly string PrimaryKey = "qnARjTm47Gn5Ik4FISkgD95lOH4W79Rz0dpzLwmf6nALVnlbOXsJiMDM28GvlLnbjes0daGloVncACDbTfbpxQ==";
        ...
        public async Task Init()
        {
            try
            {
                ...
                await _instance.GetStartedDemoAsync();
            }
